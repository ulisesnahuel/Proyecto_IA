...
for k=1:100 %100 iteraciones
    valores=zeros(50,1);
    %Asignacion de probabilidad de conjucion
    Pmut=rand(50,1);
...
for i=1:50
    ...
    sprintf('conjuncion de bit %d operado con bit %d y bit %d de individuo %d con Pmut=%3.1f %%',p3,p1,p2,i,Pmut(i)*100)
    end
end

v_out(k)=cont_out; %#ok<SAGROW> %vector que acumula los contadores de la cantidad de ind. que salieron del espacio
